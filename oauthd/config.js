module.exports = {
	...
	port: 6284, 						// You'll probably have to change this in docker-compose.yml as well
	...
	*/
	...
	redis: {
		port: 6379,
		host: 'redis-oauthd', // This is what the container is known as in the docker-compose.yml file.
